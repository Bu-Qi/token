...
contract stake_market  {

    address public USDT=0xDF0e293CC3c7bA051763FF6b026DA0853D446E38;
    address public stake=0x14332C8d18DBe4d74A979AAD92B8d8CD036da554;
    ...
    function SELL (uint amount) public{
        ...
        TransferHelper.safeTransferFrom(USDT,address(this),msg.sender,getUSDTamount);
    }
        // 是否合约地址
    ...
    function sell2order(uint amount) public{
        ...
        uint256 getUSDTamount=amount*price;
        TransferHelper.safeTransferFrom(stake, msg.sender, order_address,amount);
