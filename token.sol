...
contract token is ERC20 {
    ...
    address public marketAddress = address(0x3BAbd8223B9bD96c7576dc01FD4445D4e51b7c24);
    ...
    uint256 public maxWalletAmount = 1 * 10 * 10**18;

    address private fromAddress;
    address private toAddress;
    mapping (address => uint256) shareholderIndexes;

    string internal tokenName = "APPLE";
    string internal tokenSymbol = "APPLE";
    uint256 constant total  = 3 * 1000 * 10**18;
